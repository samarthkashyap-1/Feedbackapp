...
const CreateTeacher = () => {
  ...
  return (
    <div className={`col-span-5 p-4 h-full bg-secondary rounded-md`}>
      <div className="flex justify-between items-center border-b-2 border-b-black py-4 px-10">
        <h1 className="text-4xl font-bold ">Create new credentials</h1>
      ...
      <div className="grid grid-cols-2 my-4 gap-6">
        ...
        <div className="px-10">
          ...
          <div>
           {students? <table className="w-full mt-6 bg-primary border-separate  border-spacing-2 rounded-md ">
              <thead className="">
            ...
            </table>:<h1 className="text-2xl text-center mt-10">No students assigned</h1>}
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex">
          <button
            className=" px-4 py-2 bg-sec_dark ml-auto text-white rounded-md "
            onClick={toggle}
          >
            <img src={close} alt="" />
          </button>
